...
namespace Dapper.Contrib.Extensions
{
    ...
    public static class SqlMapperExtensions
    {
        ...
        {
            return Update<T>(connection, entityToUpdate, null, transaction, commandTimeout);
        }
        ...
        /// <param name="entityToUpdate">Entity to be updated</param>
        /// <returns>true if updated, false if not found or not modified (tracked entities)</returns>
        public static bool Update<T>(this IDbConnection connection, T entityToUpdate, string tableName, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
