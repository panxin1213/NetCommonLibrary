namespace ChinaBM.Common
{
    ...
    public class HProgressBar
    {
        ...
        public static void Start(string msg)
        {
            ...
            s += "<link href=\"/css/manage/css.css\" rel=\"stylesheet\" type=\"text/css\" />\r\n";
            ...
            s += "</div>\r\n</body>\r\n</html>\r\n";
            s += new String(' ', 1024) + Environment.NewLine;
        ...
        {
            string jsBlock = "<script language=\"javascript\">SetPorgressBar('" + Msg + "'," + Pos + ");</script>" + new String(' ', 1024);
